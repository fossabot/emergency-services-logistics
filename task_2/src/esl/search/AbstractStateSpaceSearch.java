...
public abstract class AbstractStateSpaceSearch implements StateSpaceSearch {
    ...
    public AbstractStateSpaceSearch() {
        this(fr.uga.pddl4j.planners.statespace.search.StateSpaceSearch.DEFAULT_TIMEOUT, fr.uga.pddl4j.planners.statespace.search.StateSpaceSearch.DEFAULT_HEURISTIC,
            fr.uga.pddl4j.planners.statespace.search.StateSpaceSearch.DEFAULT_HEURISTIC_WEIGHT);
    }
    ...
    public AbstractStateSpaceSearch(int timeout) {
        this(timeout, fr.uga.pddl4j.planners.statespace.search.StateSpaceSearch.DEFAULT_HEURISTIC, StateSpaceSearch.DEFAULT_HEURISTIC_WEIGHT);
    }
