...
import fr.uga.pddl4j.planners.statespace.search.*;
...
public interface StateSpaceSearch extends SearchStrategy {
    ...
    /**
     * Sets the heuristic to use to solve the problem.
     *
     * @param heuristic the heuristic to use to solve the problem. The heuristic cannot be null.
     */
     ...
     */
    static StateSpaceSearch getInstance(final Name name) {
     ...
     * @return the search strategy.
     */
    static StateSpaceSearch getInstance(final Name name, final StateHeuristic.Name heuristic) {
